...
const ClientDashboardNew = () => {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'commandes' | 'wishlist' | 'profil'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeView === 'wishlist' && (
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Ma Liste de Souhaits</h2>
            <div className="text-center py-12">
              <Heart className="h-16 w-16 text-gray-300 mx-auto mb-4" />
              <p className="text-gray-600">Votre wishlist est vide pour le moment.</p>
              <button
