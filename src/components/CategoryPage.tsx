...
const CategoryPage = ({ category, onBack }) => {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      category: 'Tenues Femmes',
      quality: 'premium',
      description: 'Caftan élégant avec broderies perlées et finitions luxueuses.',
      colors: ['#800080', '#FF1493', '#FFD700'],
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      price: 48000,
      currency: 'FCFA',
      image: 'https://images.pexels.com/photos/1121796/pexels-photo-1121796.jpeg?auto=compress&cs=tinysrgb&w=500',
      images: [
      ...
      category: 'Tenues Hommes',
      quality: 'premium',
      description: 'Grand boubou traditionnel avec broderies dorées et tissu de haute qualité.',
      colors: ['#000080', '#8B4513', '#006400'],
      sizes: ['L', 'XL', 'XXL'],
    ...
    },
    {
      ...
      rating: 4.5,
      reviews: 12,
      status: 'Sur commande - 10 jours',
      availability: 'on-order',
      category: 'Tenues Hommes',
      quality: 'premium',
      description: 'Costume moderne avec motifs africains, parfait pour les occasions spéciales.',
      colors: ['#000000', '#8B4513', '#FF6B35'],
      sizes: ['M', 'L', 'XL'],
      vendor: 'Couture Moderne',
    ...
    {
      id: 10,
      name: 'Bracelet Argent Traditionnel',
      price: 8000,
      currency: 'FCFA',
      image: 'https://images.pexels.com/photos/1927248/pexels-photo-1927248.jpeg?auto=compress&cs=tinysrgb&w=500',
      images: [
        'https://images.pexels.com/photos/1927248/pexels-photo-1927248.jpeg?auto=compress&cs=tinysrgb&w=800'
      ],
      rating: 4.6,
      reviews: 45,
      status: 'En stock',
      ...
      category: 'Accessoires',
      quality: 'standard',
      description: 'Bracelet en argent avec gravures traditionnelles sénégalaises.',
      colors: ['#C0C0C0', '#FFD700'],
      sizes: ['S', 'M', 'L'],
      vendor: 'Bijoux Artisanaux',
      delivery: '1-2 jours',
      location: 'Dakar, Sénégal',
      weight: 0.05
    },
    {
      ...
      category: 'Accessoires',
      quality: 'standard',
      description: 'Babouches traditionnelles en cuir véritable, confortables et élégantes.',
  ...
  const filteredProducts = useMemo(() => {
    let filtered = products.filter(product => {
      ...
      return matchesSearch && matchesAvailability && matchesPrice && matchesQuality;
    });
    ...
    return filtered;
  }, [products, searchTerm, selectedAvailability, priceRange, selectedQuality, sortBy]);
  ...
  const getCategoryTitle = (cat) => {
    const titles = {
      'Tenues Femmes': 'Tenues Femmes',
      'Tenues Hommes': 'Tenues Hommes',
  ...
  const getCategoryDescription = (cat) => {
    const descriptions = {
      'Tenues Femmes': 'Découvrez notre collection de tenues traditionnelles pour femmes',
      'Tenues Hommes': 'Explorez notre gamme de vêtements traditionnels pour hommes',
      'Accessoires': 'Complétez votre look avec nos accessoires artisanaux'
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">{getCategoryDescription(category)} • {filteredProducts.length} produits</p>
            </div>
          </div>
